...
namespace TempMach
{
    ...
    {
        private static Dictionary<string, BlockFacing[]> Lazyness => new()
        {
        ...
        {
            if (world.BlockAccessor.GetBlockEntity(blockSel.Position) is RedstoneTransmissionBE entity && (byPlayer.InventoryManager.ActiveHotbarSlot?.Itemstack?.Block != null || byPlayer.InventoryManager.ActiveHotbarSlot?.Itemstack == null))
            {
    ...
    public class RedstoneTransmissionBE : CamoableBE
    {
